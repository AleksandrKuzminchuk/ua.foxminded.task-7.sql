...
public class QueryConstantsStudents {
    private QueryConstantsStudents() {
    }

    public static final String SELECTION_BY_COURSE_ID_QUERY_TEMPLATE =
    ...
    public static final String DELETE_ALL_STUDENTS = "DELETE FROM public.students";
    ...
    public static final String UPDATE_STUDENT = "UPDATE public.students SET first_name = ?, last_name = ? WHERE student_id = ?";
    public static final String SAVE_STUDENT = "INSERT INTO students (first_name, last_name, group_id) VALUES (?, ?, ?)";
    public static final String FIND_BY_ID_STUDENT = "SELECT * FROM public.students WHERE student_id = ?";
