...
import ua.foxminded.task7.sql.dao.constants.QueryConstantsGroups;
...
public class GroupDaoImpl implements GroupDao {
    ...
    public void deleteById(Integer groupId) {
        ...
        try (PreparedStatement statement = connectionUtils.getConnection()
                .prepareStatement(QueryConstantsGroups.DELETE_BY_ID_GROUP)) {
            statement.setInt(1, groupId);
            statement.executeUpdate();
    ...
    public void delete(Group groupName) {
        ...
        try (PreparedStatement statement = connectionUtils.getConnection()
                .prepareStatement(QueryConstantsGroups.DELETE_GROUPS)) {
